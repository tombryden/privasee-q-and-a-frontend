...
export type UpdateQuestionOrAnswerMutation = { __typename?: 'Mutation', updateQuestionOrAnswer: { __typename?: 'Record', _recordId: string, question: string, answer?: string | null, updatedAt: any, updatedBy: string } };
