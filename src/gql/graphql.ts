...
export type AllRecordsQuery = { __typename?: 'Query', records: Array<{ __typename?: 'Record', _recordId: string, question: string, answer?: string | null, createdBy: string, createdAt: any, assignedTo: string }> };
